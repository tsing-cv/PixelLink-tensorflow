...
if __name__ == '__main__':
    ...
    print(coord2)
    # print(coord3-coord2)
    coord_label = np.array([[167., 203., 96., 132., 132., 96., 203., 167.]])
    
    # coord4 = back_forward_convert(coord_label, with_label=True)
    coord5 = back_forward_convert(coord_label, False)
